...
from sklearn.impute import SimpleImputer ##Import missing values
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info(f"categorical columns:{catogerical_columns}")

            preprocessor=ColumnTransformer(
                [
                    ("num_pipeline",num_pipeline,numerical_columns),
                    ("cat_pipeline",cat_pipeline,catogerical_columns)
                ]
            )
